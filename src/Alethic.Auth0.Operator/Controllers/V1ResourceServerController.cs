...
namespace Alethic.Auth0.Operator.Controllers
{
        ...
        IEntityController<V1ResourceServer>
    {
        ...
        public V1ResourceServerController(IKubernetesClient kube, EntityRequeue<V1ResourceServer> requeue, IMemoryCache cache, ILogger<V1ResourceServerController> logger, IOptionsMonitor<ReconciliationOptions> reconciliationConfig) :
